import {
  require_Fullscreen,
  require_FullscreenExit,
  require_Share
} from "./chunk-2MTTUOZK.js";
import {
  require_Add
...
import "./chunk-J34WXHB4.js";
import "./chunk-VJSPU622.js";
import "./chunk-SRTTMZV5.js";
...
// ../node_modules/@material-ui/icons/PanTool.js
var require_PanTool = __commonJS({
  "../node_modules/@material-ui/icons/PanTool.js"(exports) {
    "use strict";
...
var require_CloseOutlined = __commonJS({
  "../node_modules/@material-ui/icons/CloseOutlined.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault();
    var _interopRequireWildcard = require_interopRequireWildcard();
    Object.defineProperty(exports, "__esModule", {
...
// ../node_modules/@eclipse-sirius/sirius-components-portals/dist/sirius-components-portals.es.js
var import_jsx_runtime = __toESM(require_jsx_runtime());
var import_Add = __toESM(require_Add());
var import_react = __toESM(require_react());
var import_react_grid_layout = __toESM(require_react_grid_layout());
import "/home/loren/tirocinio/org.eclipse.papyrus-web/frontend/node_modules/react-grid-layout/css/styles.css";
...
`;
var isPortalRefreshedEventPayload = (payload) => payload.__typename === "PortalRefreshedEventPayload";
var usePortal = (editingContextId, representationId) => {
...
`;
var removePortalViewMutation = gql`
...
`;
function useErrorReporting(result, extractPayload) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (!loading) {
      ...
      const payload = extractPayload(data || null);
...
var usePortalMutations = (editingContextId, portalId) => {
  ...
  useErrorReporting(rawAddPortalViewResult, (data) => data == null ? void 0 : data.addPortalView);
  ...
  useErrorReporting(rawRemovePortalViewResult, (data) => data == null ? void 0 : data.removePortalView);
  const [layoutsInProgress, setLayoutsInProgress] = (0, import_react.useState)(0);
  ...
  useErrorReporting(rawLayoutPortalResult, (data) => data == null ? void 0 : data.layoutPortalView);
  return {
    addPortalView,
    removePortalView,
    layoutPortal,
...
var useFullscreen = (domNode) => {
  const [fullscreen, setFullscreenState] = (0, import_react.useState)(false);
  (0, import_react.useEffect)(() => {
    const onFullscreenChange = () => setFullscreenState(Boolean(document.fullscreenElement));
    document.addEventListener("fullscreenchange", onFullscreenChange);
    return () => document.removeEventListener("fullscreenchange", onFullscreenChange);
  }, []);
  const setFullscreen = (0, import_react.useCallback)(
    (fullscreen2) => {
      if (domNode.current) {
        if (fullscreen2) {
...
var PortalToolbar = ({
  ...
  const [state, setState] = (0, import_react.useState)({ modal: null });
  ...
  if (state.modal === "share") {
    modalElement = (0, import_jsx_runtime.jsx)(
      ShareRepresentationModal,
      {
        editingContextId,
        representationId,
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsxs)(Paper_default, { "data-testid": "portal-toolbar", children: [
      fullscreen ? (0, import_jsx_runtime.jsx)(Tooltip_default, { title: "Exit full screen mode", children: (0, import_jsx_runtime.jsx)(IconButton_default, { size: "small", "aria-label": "exit full screen mode", onClick: () => setFullscreen(false), children: (0, import_jsx_runtime.jsx)(import_FullscreenExit.default, {}) }) }) : (0, import_jsx_runtime.jsx)(Tooltip_default, { title: "Toggle full screen mode", children: (0, import_jsx_runtime.jsx)(IconButton_default, { size: "small", "aria-label": "toggle full screen mode", onClick: () => setFullscreen(true), children: (0, import_jsx_runtime.jsx)(import_Fullscreen.default, {}) }) }),
      (0, import_jsx_runtime.jsx)(Tooltip_default, { title: "Share portal", children: (0, import_jsx_runtime.jsx)(IconButton_default, { size: "small", "aria-label": "share portal", onClick: onShare, "data-testid": "share", children: (0, import_jsx_runtime.jsx)(import_Share.default, {}) }) }),
      (0, import_jsx_runtime.jsx)(Tooltip_default, { title: "Edit portal configuration", children: (0, import_jsx_runtime.jsx)(
        IconButton_default,
        {
          size: "small",
          ...
          children: (0, import_jsx_runtime.jsx)(import_Edit.default, {})
        }
      ) }),
      (0, import_jsx_runtime.jsx)(Tooltip_default, { title: "Edit representations", children: (0, import_jsx_runtime.jsx)(
        IconButton_default,
        {
          size: "small",
          ...
          children: (0, import_jsx_runtime.jsx)(import_PanTool.default, {})
        }
      ) })
    ] }),
    modalElement
...
var useFrameStyles = makeStyles_default((theme) => ({
  representationFrame: {
    display: "grid",
...
var RepresentationFrame = ({
  editingContextId,
  representation,
  portalMode,
  onDelete
}) => {
  const { registry } = (0, import_react.useContext)(RepresentationContext);
  ...
  if (RepresentationComponent) {
    ...
    return (0, import_jsx_runtime.jsxs)("div", { "data-testid": `representation-frame-${representation.label}`, className: classes.representationFrame, children: [
      (0, import_jsx_runtime.jsxs)("div", { className: classes.frameHeader, "data-testid": "representation-frame-header", children: [
        (0, import_jsx_runtime.jsx)(Typography_default, { variant: "subtitle2", className: classes.title + " draggable", children: representation.label }),
        portalMode === "edit" ? (0, import_jsx_runtime.jsx)(
          IconButton_default,
          {
            "aria-label": "remove",
            onClick: (e) => {
            ...
            size: "small",
            children: (0, import_jsx_runtime.jsx)(import_CloseOutlined.default, { fontSize: "small" })
          }
        ) : null
      ] }),
      (0, import_jsx_runtime.jsx)(RepresentationComponent, { ...props }, `${editingContextId}#${representation.id}`)
    ] });
  } else {
    return (0, import_jsx_runtime.jsx)("div", { children: "Unknown representation kind" });
  }
};
var usePortalRepresentationStyles = makeStyles_default((theme) => ({
...
var ResponsiveGridLayout = (0, import_react_grid_layout.WidthProvider)(import_react_grid_layout.default);
var getFirstDroppedElementId = (event) => {
...
var PortalRepresentation = ({
  ...
  const domNode = (0, import_react.useRef)(null);
  const { addErrorMessage } = useMultiToast();
  ...
  const nonPropagatingSetSelection = (0, import_react.useCallback)(
    (selection2) => {
  ...
  let items = [
    (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          (0, import_jsx_runtime.jsx)(import_Add.default, { fontSize: "large" }),
          (0, import_jsx_runtime.jsx)(Typography_default, { variant: "subtitle2", align: "center", children: "Add representations by dropping them from the explorer" })
        ]
      },
      "drop-area"
    )
  ...
  if (mode && portal && portal.views.length > 0) {
    items = portal.views.filter((view) => {
      ...
      if (layout && view.representationMetadata) {
        ...
        return (0, import_jsx_runtime.jsx)("div", {}, view.id);
      }
    });
  }
  if (message) {
    return (0, import_jsx_runtime.jsx)("div", { children: message });
  }
  if (complete) {
    return (0, import_jsx_runtime.jsx)("div", { children: "The representation is not available anymore" });
  }
  if (!portal || !mode) {
    return (0, import_jsx_runtime.jsx)("div", {});
  }
  const cellSize = theme.spacing(3);
  return (0, import_jsx_runtime.jsxs)("div", { className: classes.portalRepresentationArea, ref: domNode, "data-representation-kind": "portal", children: [
    ...
    (0, import_jsx_runtime.jsx)(SelectionContext.Provider, { value: { selection, setSelection: nonPropagatingSetSelection }, children: (0, import_jsx_runtime.jsx)(
...
//# sourceMappingURL=@eclipse-sirius_sirius-components-portals.js.map
